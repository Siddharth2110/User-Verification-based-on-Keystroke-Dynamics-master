...
path = "C:\\Users\\Siddharth\\Desktop\\Python files\\User-Verification-based-on-Keystroke-Dynamics-master\\keystroke.csv" 
data = pandas.read_csv(path)
subjects = data["subject"].unique()
print ("average EER for Manhattan Filtered Scaled detector:")
